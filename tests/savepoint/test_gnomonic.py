...
from fv3core.grid.gnomonic import (
    _latlon2xyz,
    _xyz2latlon,
...
def test_great_circle_distance_along_axis(lon, lat, radius, axis, reference):
    result = great_circle_distance_along_axis(lon, lat, radius, np, axis)
