...
class TranslateMap1_PPM_2d(TranslateFortranData2Py):
    ...
    def compute(self, inputs):
        ...
        inputs["i1"] = self.grid.global_to_local_x(inputs["i1"]+ TranslateGrid.fpy_model_index_offset)
        inputs["i2"] = self.grid.global_to_local_x(inputs["i2"]+ TranslateGrid.fpy_model_index_offset)
        inputs["qmin"] = 0.0
