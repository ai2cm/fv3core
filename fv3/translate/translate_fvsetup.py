...
class TranslateFVSetup(TranslateFortranData2Py):
    def __init__(self, grid):
        ...
        self.in_vars["data_vars"] = {
            ...
            "delz": {}, "delp": {}, "cappa": {},"q_con":{}, "dp1":{},
            "cvm": {"kstart": grid.is_, "axis": 0},
    
        }
        self.in_vars["parameters"] = ["zvir"]
        self.out_vars = {
            "cvm": {"istart": grid.is_, "iend": grid.ie , "jstart":grid.je, "jend":grid.je, "kstart":grid.npz, "kend":grid.npz }, "dp1":{},"q_con": {},
            "pkz": grid.compute_dict(),  "cappa":{}
