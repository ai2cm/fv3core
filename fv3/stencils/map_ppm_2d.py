                ...
                if pe2[ii, k2] >= pe1[ii, k1] and pe2[ii, k2] <= pe1[ii, k1 + 1]:
                    ...
                    if (
                        ...
                        q2[ii, jj, k2] = (
                            q4_2[ii, 1, k1]
                            + 0.5
                            * (q4_4[ii, 1, k1] + q4_3[ii, 1, k1] - q4_2[ii, 1, k1])
                            * (pr + pl)
                            - q4_4[ii, 1, k1] * r3 * (pr * (pr + pl) * pl ** 2)
                        )
                        k0 = k1
                        continue
                        ...
                        qsum = (pe1[ii, k1 + 1] - pe2[ii, k2]) * (
                            q4_2[ii, 1, k1]
                            + 0.5
                            * (q4_4[ii, k1] + q4_3[ii, 1, k1] - q4_2[ii, 1, k1])
                            * (1.0 + pl)
                            - q4_4[ii, 1, k1] * (r3 * (1.0 + pl * (1.0 + pl)))
                        )
