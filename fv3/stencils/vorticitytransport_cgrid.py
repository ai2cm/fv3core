...
def compute(uc, vc, vort_c, ke_c, v, u, fxv, fyv, dt2):
    ...
    compute_tmp_flux( fx1, dt2, u, vc, grid.cosa_v, grid.sina_v, origin=co, domain=meridional_domain )
    compute_tmp_flux( fy1, dt2, v, uc, grid.cosa_u, grid.sina_u, origin=co, domain=zonal_domain )
