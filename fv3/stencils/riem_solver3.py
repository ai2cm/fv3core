...
def finalize(zs: sd, dz: sd, zh: sd, peln_run: sd, peln: sd, pk3: sd, pk: sd, pem: sd, pe: sd, ppe: sd, last_call: bool):
...
def compute(
    ...
    finalize_stencil(zs, delz, zh, peln_run, peln, pk3, pk, pem, pe, ppe, last_call,origin=riemorigin, domain=domain)
