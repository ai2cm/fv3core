<<<<<<< HEAD
=======
<<<<<<<< HEAD:fv3core/testing/parallel_translate.py
>>>>>>> master
import copy
...
# from fv3core.testing import TranslateFortranData2Py, read_serialized_data
...
#         self._base.compute_func(**state)
#         return self._base.slice_output(vars(state["state"]))
>>>>>>>> master:tests/translate/parallel_translate.py
>>>>>>> master
