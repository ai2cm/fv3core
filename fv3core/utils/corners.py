...
def fill_corners_cells_x(q: FloatField):
    ...
    """
    return fill_corners_cells_mult_x(q, q, 1, 1, 1, 1)


def fill_corners_cells_mult_y(
    q: FloatField,
    q_corner: FloatField,
    sw_mult: float,
    se_mult: float,
...
def fill_corners_cells_y(q: FloatField):
    ...
    """
    return fill_corners_cells_mult_y(q, q, 1, 1, 1, 1)


def fill_corners_cells(q: FloatField, direction: str):
    """
    ...
    if direction == "x":
        stencil = gtstencil(
            definition=definition, externals={"func": fill_corners_cells_x}
        )
        stencil(q, **kwargs)
    elif direction == "y":
        stencil = gtstencil(
            definition=definition, externals={"func": fill_corners_cells_y}
        )
        stencil(q, **kwargs)
    else:
