...
def compute(state, nq, dt):
    ...
    u0 = utils.make_storage(shape, origin)
    v0 = utils.make_storage(shape, origin)
    w0 = utils.make_storage(shape, origin)
    gzh = utils.make_storage(shape, origin)
    gz = utils.make_storage(shape, origin)
    t0 = utils.make_storage(shape, origin)
    pm = utils.make_storage(shape, origin)
    hd = utils.make_storage(shape, origin)
    te = utils.make_storage(shape, origin)
    den = utils.make_storage(shape, origin)
    qcon = utils.make_storage(shape, origin)
    cvm = utils.make_storage(shape, origin)
    cpm = utils.make_storage(shape, origin)
    ...
    ri = utils.make_storage(shape, origin)
    ri_ref = utils.make_storage(shape, origin)
    mc = utils.make_storage(shape, origin)
    h0 = utils.make_storage(shape, origin)
    pt1 = utils.make_storage(shape, origin)
    pt2 = utils.make_storage(shape, origin)
    tv2 = utils.make_storage(shape, origin)
