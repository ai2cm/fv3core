...
class FiniteVolumeTransport:
    ...
    def __init__(self, namelist, hord):
        ...
        self.stencil_q_i = fv3_stencil(definition=q_i_stencil, **stencil_kwargs)
        self.stencil_q_j = fv3_stencil(definition=q_j_stencil, **stencil_kwargs)
        self.stencil_transport_flux = fv3_stencil(
            definition=transport_flux_xy, **stencil_kwargs
        )
