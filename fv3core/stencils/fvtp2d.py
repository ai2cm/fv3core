...
class FiniteVolumeTransport:
    ...
    def __init__(self, namelist, hord):
        ...
        self.xppm_inner = XPiecewiseParabolic(spec.namelist, ord_inner)
        self.yppm_inner = YPiecewiseParabolic(spec.namelist, ord_inner)
        self.xppm_outer = XPiecewiseParabolic(spec.namelist, ord_outer)
        self.yppm_outer = YPiecewiseParabolic(spec.namelist, ord_outer)
