...
def compute(
    ...
    den = utils.make_storage(peln.shape, utils.origin)
    wqsat = utils.make_storage(peln.shape, utils.origin)
    dq2dt = utils.make_storage(peln.shape, utils.origin)
    pt1 = utils.make_storage(peln.shape, utils.origin)
    cvm = utils.make_storage(peln.shape, utils.origin)
    q_liq = utils.make_storage(peln.shape, utils.origin)
    mc_air = utils.make_storage(peln.shape, utils.origin)
    q_sol = utils.make_storage(peln.shape, utils.origin)
    tcp3 = utils.make_storage(peln.shape, utils.origin)
    lhl = utils.make_storage(peln.shape, utils.origin)
    lhi = utils.make_storage(peln.shape, utils.origin)
    lcp2 = utils.make_storage(peln.shape, utils.origin)
    icp2 = utils.make_storage(peln.shape, utils.origin)
    tin = utils.make_storage(peln.shape, utils.origin)
    q_cond = utils.make_storage(peln.shape, utils.origin)
    qpz = utils.make_storage(peln.shape, utils.origin)
    satadjust_part1(
        wqsat,
        dq2dt,
        dpln,
