...
def compute(u, v, pp, gz, pk3, delp, dt, ptop, akap):
    ...
    wk1 = utils.make_storage(pp.shape, origin=orig)
    wk = utils.make_storage(pk3.shape, origin=orig)
    ...
    du = utils.make_storage(u.shape, origin=orig)
    ...
    dv = utils.make_storage(v.shape, origin=orig)
