...
def compute(
    ...
    # TODO if nq > 5:
    mapn_tracer.compute(
        pe1, pe2, dp2, tracers, nq, 0.0, grid.is_, grid.ie, grid.js, grid.je, abs(spec.namelist.kord_tr)
    )
    # TODO else if nq > 0:
    # TODO map1_q2, fillz
    kord_wz = spec.namelist.kord_wz
    map_single.compute(w, pe1, pe2, wsd, -2, grid.is_, grid.ie, grid.js, grid.je, kord_wz)
    map_single.compute(delz, pe1, pe2, gz, 1, grid.is_, grid.ie, grid.js, grid.je, kord_wz)
    ...
    map_single.compute(
        u, pe0, pe3, gz, -1, grid.is_, grid.ie, grid.js, grid.je + 1, spec.namelist.kord_mt
    )
    ...
    map_single.compute(
        v, pe0, pe3, gz, -1, grid.is_, grid.ie + 1, grid.js, grid.je, spec.namelist.kord_mt
    )
